  ...
  return (
    ...
    >
        ...
        <div className="flex flex-wrap gap-1">
          {selected.map((option) => {
            return (
              <div
                key={option.value}
                className="rounded-lg bg-gradient-to-r from-accent-nvidia from-10% to-50% to-accent-charcoal flex flex-wrap gap-1"
              >
                <div
                  className={cn(
                    'animate-fadeIn text-foreground hover:bg-accent-dusk/40 relative inline-flex h-7 cursor-default items-center rounded-md ps-2 pe-7 pl-2 text-xs font-medium transition-all disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 data-fixed:pe-2 backdrop-blur-3xl',
                    badgeClassName
                  )}
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              'placeholder:text-accent-mist flex-1 bg-transparent outline-hidden disabled:cursor-not-allowed',
              {
      ...
      <div className="relative">
        <div
          className={cn(
            'border-accent-fog absolute top-2 z-10 w-full overflow-hidden rounded-md border',
        ...
        >
          {open && (
            <CommandList
              className="bg-accent-dusk text-foreground border-accent-fog rounded-lg shadow-lg outline-hidden p-1.5"
              onMouseLeave={() => {
                        ...
                        {dropdowns.map((option) => {
                          return (
                            <CommandItem
                              ...
                              className={cn(
                                'cursor-pointer bg-accent-dusk hover:bg-accent-fog/40 hover:text-white focus:text-white px-2 py-1 rounded-sm',
                                option.disable &&
